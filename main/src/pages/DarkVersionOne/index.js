                    ...
                    <div className="col">
                      <div className="section-title text-center mb-4 pb-2">
                        <h4 className="title text-white title-dark mb-4">
                          Join the fastest growing Chain Master Finance NFTs <br /> with more
                          than 2000+ NFTs
                        </h4>
                        <p className="text-white-50 para-desc mb-0 mx-auto">
                          CMF is a top marketplace dedicated to connecting
                          great artists on Chain Master Finance with their fans and
                  ...
                  <div className="row">
                    <div className="col-md-6 mt-4 pt-2">
                      <div className="card p-4 rounded-md shadow bg-white">
                        ...
                        <p className="text-muted mb-0">
                          CMF is a top marketplace dedicated to connecting
                          great artists on Chain Master Finance.
                        </p>
                    ...
                    <div className="col-md-6 mt-4 pt-2">
                      <div className="card p-4 rounded-md shadow bg-white">
                        <h4 className="mb-4">Learn more about Chain Master Finance</h4>
                        <p className="text-muted mb-0">
                          CMF is a top marketplace dedicated to connecting
                          great artists on Chain Master Finance.
                        </p>
